...
import com.example.demofooddelivery.data.ProductionHighlightType
...
private object HighlightDefaults {
    ...
    @Composable
    fun colors(type: ProductionHighlightType): HighlightColors = when(type) {
        ProductionHighlightType.PRIMARY -> HighlightColors(
            containerColor = AppTheme.colors.highlightSurface,
            contentColor = AppTheme.colors.onHighlightSurface,
        )
        ProductionHighlightType.SECONDARY -> HighlightColors(
